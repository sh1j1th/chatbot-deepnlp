...
###performing first cleaning on the texts
def clean_text(text):
    text = text.lower()
...
###creating a dictionary that maps each words to its number of occurences
word2count = {}
...
###sorting questions and answers by length of the questions
...
###PART 2_BUILDING SEQ2SEQ MODEL###


###creating a placeholder for the inputs and targets
def model_inputs():
...
def encoded_rnn_layer(rnn_inputs, rnn_size, num_layers, keep_prob, sequence_length):
